...
# Docker container runs as UID 1001 (www user)
DOCKER_UID=1001
DOCKER_GID=1001
...
echo "🔐 Setting ownership to UID:GID ${DOCKER_UID}:${DOCKER_GID} (www user)..."
...
echo ""
echo "ℹ️  Note: Container runs as www user (UID 1001) for security"