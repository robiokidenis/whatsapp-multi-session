  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showApiKeyModal && selectedUserForApiKey && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-100 max-h-[90vh] overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">@{selectedUserForApiKey.username}</p>
                </div>
              </div>
              <button
              ...
              <div className="space-y-4">
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start">
                    ...
                    <p className="text-xs text-blue-800">API keys provide secure programmatic access without username/password auth.</p>
                  </div>
                </div>
                ...
                {generatedApiKey && (
                  <div className="border border-green-200 rounded-lg p-3 bg-green-50">
                    <div className="flex items-center mb-2">
                      ...
                      <p className="text-xs font-medium text-green-800">API Key Generated! Copy now - won't be shown again</p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        readOnly
                        className="flex-1 px-3 py-2 border border-green-300 rounded-lg bg-white font-mono text-xs"
                      />
                      <button
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:bg-primary-400 transition-colors flex items-center justify-center text-sm font-medium"
                  >
                    {apiKeyLoading ? (
                      <>
                  ...
                  <button
                    ...
                    disabled={apiKeyLoading}
                    className="px-4 py-2 border border-red-300 text-red-700 bg-white rounded-lg hover:bg-red-50 disabled:opacity-50 transition-colors flex items-center justify-center text-sm font-medium"
                  >
                    <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
                ...
                <div className="border border-gray-200 rounded-lg p-3">
                  ...
                  <div className="space-y-2">
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Include in headers:</p>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-900 text-green-400 p-2 rounded font-mono text-xs overflow-x-auto">
                        curl -H "Authorization: Bearer key" {window.location.origin}/api/sessions
                      </div>
                    </div>
                  </div>
                </div>
